...
class RoomManagement:
    ...
    def create_widgets(self):
        ...
        self.room_list.grid(row=1, column=0, sticky="nsew", padx=5, pady=5)
    ...
    def on_select(self, event):
        selection = self.room_list.get(self.room_list.curselection())
        if selection:
            room_id = int(selection.split(':')[0].split()[1])
